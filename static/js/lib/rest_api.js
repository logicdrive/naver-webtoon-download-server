...
class Rest_Api
{
  ...
  {
    const REQ_RESULT = await Rest_Api.request_With_Error_Check(`/api/v1/webtoon_title?keyword=${keyword}`, "GET")
  ...
  {
    const REQ_RESULT = await Rest_Api.request_With_Error_Check("/api/v1/webtoon_image", "POST", {"webtoon_infos":webtoon_infos})
